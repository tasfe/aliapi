...
//使用前请看文档http://open.taobao.com/dev/index.php/API2.0:Taobao.user.get
...
$paramArr = array(
    ...
    'method' => 'taobao.user.get',//API接口名称
    ...
    'nick' => 'top技术支持'//用户昵称，如果昵称为中文，请使用UTF-8字符集对昵称进行URL编码
...
print_r($result);
echo '<br />----------------源代码----------------<br />';
highlight_file('taobao.user.get.php');
?>