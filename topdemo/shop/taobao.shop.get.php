...
//使用前请看文档http://open.taobao.com/dev/index.php/API2.0:Taobao.shop.get
...
$paramArr = array(
    ...
    'method' => 'taobao.shop.get',//API接口名称
    ...
    'fields' => 'sid,cid,title,nick,desc,bulletin,created,modified',//需返回的字段列表。
    'nick' => 'top技术支持'//卖家昵称。如果昵称为中文，请使用UTF-8字符集对昵称进行URL编码
);
...
print_r($result);
echo '<br />----------------源代码----------------<br />';
highlight_file('taobao.shop.get.php');
?>